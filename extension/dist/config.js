...
exports.getKeywordsForLanguage = exports.saveConfig = exports.getConfig = exports.DEFAULT_CONFIG = void 0;
...
const getConfig = async () => {
    try {
        ...
        return { ...exports.DEFAULT_CONFIG, ...stored.config };
    }
    catch {
...
const getKeywordsForLanguage = (language) => {
    return exports.DEFAULT_CONFIG.keywords.filter(k => k.language === language);
};
exports.getKeywordsForLanguage = getKeywordsForLanguage;
